...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, num_frames=1,  split="train", **kwargs):
    # def __init__(self, num_frames=1,  split="train", sampling="conseq", sampling_step=1,
    ...
    def __getitem__(self, index):
        ...
        cur_data = self._get_item_data_index(data_index)
        return cur_data # a dictionary includes paired data sample
